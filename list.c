...
char *tokens_1[128] = {
	...
	"POKE", "CONT", "CSAVE", "CLOAD", "OUT", "LPRINT", "LLIST",
	"CLS",


	/* A0-AF */
	"WIDTH", "ELSE", "TRON", "TROFF", "SWAP", "ERASE", "ERROR",
	"RESUME", "DELETE", "AUTO", "RENUM", "DEFSTR", "DEFINT",
	"DEFSNG", "DEFDBL", "LINE",


	/* B0-BF */
	"OPEN", "FIELD", "GET", "PUT", "CLOSE", "LOAD", "MERGE", "FILES",
	"LSET", "RSET", "SAVE", "LFILES", "CIRCLE", "COLOR", "DRAW",
	"PAINT",
	...
	/* D0-DF */
	"BSAVE", "DSKO$", "SET", "NAME", "KILL", "IPL", "COPY", "CMD",
	"LOCATE", "TO", "THEN", "TABC", "STEP", "USR", "FN", "SPCL",


	/* E0-EF */
	"NOT", "ERL", "ERR", "STRING$", "USING", "INSRT", "", "VARPTR",
	"CSRLIN", "ATTR$", "DSKI$", "OFF", "INKEY$", "POINT", ">", "=",
...
/* 90-9F */
	"INP", "POS", "LEN", "STR$", "VAL", "ASC", "CHR$", "PEEK", "VPEEK",
	"SPACE$",
	"OCT$", "HEX$", "LPOS", "BIN$", "CINT", "CSNG",
